...
import static com.jds.varadhi.jds.PasscodeView.PasscodeViewType.TYPE_CHECK_PASSCODE;
import static com.jds.varadhi.jds.PasscodeView.PasscodeViewType.TYPE_SET_PASSCODE;
...
public class PasscodeView extends FrameLayout implements View.OnClickListener {
    ...
    private int correctStatusColor = 0xFF72D548; //0xFFFF0000
    private int wrongStatusColor = 0xFFF24055;
    private int normalStatusColor = 0x66666666;
    private int numberTextColor = 0x000000;
    ...
    public PasscodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        inflate(getContext(), R.layout.passcodenew, this);
        ...
        firstInputTip = firstInputTip == null ? "Set your MPIN" +
                "" : firstInputTip;
